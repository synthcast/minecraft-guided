...
if [[ $VER == 1.16.5 ]]; then
        ...
        wget https://launcher.mojang.com/v1/objects/332b3382108e5bdb0b23717082c9b97c54ffc8ad/server.jar -O minecraft_server.1.15.jar
elif [[ $VER == 1.14 ]]; then
	...
	wget https://launcher.mojang.com/v1/objects/d0caafb8438ebd206f99930cfaecfa6c9a13dca0/server.jar -O minecraft_server.1.13.jar
elif [[ $VER == 1.12 ]]; then
	wget https://launcher.mojang.com/v1/objects/8494e844e911ea0d63878f64da9dcc21f53a3463/server.jar -O minecraft_server.1.12.jar
elif [[ $VER == 1.11 ]]; then 
	wget https://launcher.mojang.com/v1/objects/48820c84cb1ed502cb5b2fe23b8153d5e4fa61c0/server.jar -O minecraft_server.1.11.jar
elif [[ $VER == 1.10 ]]; then
	wget https://launcher.mojang.com/v1/objects/a96617ffdf5dabbb718ab11a9a68e50545fc5bee/server.jar -O minecraft_server.1.10.jar
elif [[ $VER == 1.9 ]]; then
	wget https://launcher.mojang.com/v1/objects/b4d449cf2918e0f3bd8aa18954b916a4d1880f0d/server.jar -O minecraft_server.1.9.jar
fi
custom
}
